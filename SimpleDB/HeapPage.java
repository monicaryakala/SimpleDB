...
public class HeapPage implements Page {
	...
	public byte[] getPageData() {
     ...
     writeInt(b,0,this.tuples.size());
     int p=b.length;
     
     for(int i=0;i<tuples.size();i++)
     {
    	 byte[] byteArray=toByteArray(tuples.get(i));
    	 int cOffset=p-byteArray.length;      
    	 
    	 System.arraycopy(byteArray, 0, b, cOffset, byteArray.length);
    	 writeInt(b,4 +4*i , cOffset);
    	 p=cOffset;
     }
     return b;
     }
	...
	public Iterator<Tuple> iterator() {
		...
		int nt = readInt(this.getPageData(),0);
		for(int i=0;i<nt;i++)
		{
			if(this.getTuple(i) !=null)
{
	tl.add(this.getTuple(i));
}
